...
<body>
    ...
    <div class="info-section">
        ...
        <div class="info-box">
            <h3>Fournisseur</h3>
            <p><strong>Nom:</strong> {{ $bonCommande->fournisseur->nom_fournisseur }}</p>
            <p><strong>Gérant:</strong> {{ $bonCommande->fournisseur->nom_gerant }}</p>
            <p><strong>Téléphone:</strong> {{ $bonCommande->fournisseur->telephone }}</p>
            @if($bonCommande->fournisseur->ville)
                <p><strong>Ville:</strong> {{ $bonCommande->fournisseur->ville }}</p>
            @endif
            @if($bonCommande->fournisseur->ice)
                <p><strong>ICE:</strong> {{ $bonCommande->fournisseur->ice }}</p>
            @endif
        </div>
    </div>
