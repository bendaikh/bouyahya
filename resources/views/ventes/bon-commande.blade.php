...
@section('title', 'Bon de commande ventes - Bouyahya')
...
<div x-data="{
    ...
    addItem() {
        if (this.formData.codeArticle && this.formData.nomArticle) {
            this.items.push({
                code_article: this.formData.codeArticle,
                designation: this.formData.nomArticle,
                quantite: 1,
                prix_unitaire: 0,
                sous_total: 0
            });
            this.formData.codeArticle = '';
            this.formData.nomArticle = '';
        }
    },
    removeItem(index) {
...
function printBonCommande(id) {
    ...
    <div x-show="showForm" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Client à livrer</label>
        ...
        <!-- Client/Article Information -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Code Article</label>
                <input type="text" x-model="formData.codeArticle" placeholder="Rechercher par code..." class="w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nom de l'Article</label>
                <input type="text" x-model="formData.nomArticle" placeholder="Remplissage automatique" class="w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white focus:ring-blue-500 focus:border-blue-500">
            </div>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    <template x-for="(item, index) in items" :key="index">
                        <tr>
                            <td class="px-4 py-3 text-sm text-gray-900 dark:text-white" x-text="item.code_article"></td>
                            <td class="px-4 py-3 text-sm text-gray-900 dark:text-white" x-text="item.designation"></td>
                            <td class="px-4 py-3">
